...
const HpIcon = () => {
  return (
    <svg aria-hidden="true" focusable="false" data-prefix="faga" data-icon="hp" role="img" xmlns="http://www.w3.org/2000/svg"
         viewBox="0 0 14 14">
      <g>
        <path fill="currentColor"
              d="M7.98 8.03a12.566 12.566 0 0 1 1.573-1.509c.569-.413.94 1.11.94 1.11a3.731 3.731 0 0 1-2.513.399z"></path>
        <path fill="currentColor"
